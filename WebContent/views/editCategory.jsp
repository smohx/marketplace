...
$(document).ready(function(){
	...
	$.get("fetchCategoryDetails",{ categoryCode:$('#code').val() }, function(data, status){
                ...
                img.attr("src", "images/"+data.iconURL);
                img.addClass("catIcon");
                img.attr("id", imgID);
                img.attr("img-id", data.iconURL);
                $('#imgdiv'+imgID).append(img);	
                $('#level').val(data.level);
                var supercat = data.superCategory;
                if(data.level === 'L2'){
        ...
        <div class="row" id="edit-content">  
            ...
            <form role="form" class="col-xs-6">
              <div class="box-body">
                  ...
                  <input type="text" class="form-control" id="code" placeholder="Category Code" value = "${code}" disabled>
                </div>
                <div class="form-group">
              ...
              <div class="box-body">
              <div class="form-group">
                <a class="btn btn-primary modifyCategory">Save Category</a>
              </div>
              </div>
            </form>
          </div>
